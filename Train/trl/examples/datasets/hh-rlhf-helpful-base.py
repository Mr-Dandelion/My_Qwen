...
class ScriptArguments:
    ...
    Args:
        ...
        repo_id (`str`, *optional*, defaults to `"trl-lib/hh-rlhf-helpful-base_env"`):
    ...
    repo_id: str = field(
        default="trl-lib/hh-rlhf-helpful-base_env", metadata={"help": "Hugging Face repository ID to push the dataset to."}
    )
...
if __name__ == "__main__":
    ...
    dataset = load_dataset("Anthropic/hh-rlhf", data_dir="helpful-base_env")
